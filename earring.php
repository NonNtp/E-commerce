...
<body>
    <?php include('nav.php') ?>
    <?php
    $stmt = $pdo->prepare("SELECT product.product_id , product.product_name , product.product_price,product.product_color,product.product_metal FROM product WHERE product.type_id = 5;");
    $stmt->execute();
    ?>
    <div class="inner">
        ...
        <div class="slideshow-container">
            <div class="mySlides">
                <img src="./img/earrings.png" style="width:100%">
            </div>
        </div>
